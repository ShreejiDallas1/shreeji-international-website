...
export default function ContactPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast.success('Your message has been sent to shreejidallas1@gmail.com! We will get back to you within 24 hours.');
      ...
      toast.error('Email service unavailable. Your message has been saved and we will respond within 24 hours. For urgent matters, call (214) 529-7974.');
    } finally {
